...
def parse_args():
    ...
    parser.add_argument('--joint_training', default=True)
        ...
        while restart:
            ...
            for epoch in range(config.epoch):
                ...
                # if epoch % 1000 == 0 or epoch == config.epoch-1:
                    solution, recall, room_wise_acc, _ = test_colocation(test_x_reserved, test_y, model, fold, args.split)
            ...
            for n_iter in tqdm(range(n_epoch)):
                ...
                fine_tune = False
                if args.joint_training == True and n_iter % 10 == 0:
                    fine_tune = True
                log = alg.train_dqn(
                        target_bg=train_g
                        , epoch=n_iter
                        ...
                        , ddqn=ddqn
                        , raw_x=RI_train_in
                        , fine_tune=fine_tune) #amplification*RI_train_in+perturbation
                ...
                # if 100 <= n_iter <= 300:
                #     if np.round(log.get_current('Q_error'), 3) < 60:
                #         print('Restarting...\n')
                #         break
                if n_iter > 300:
                    restart = False
                ...
                if validation_step and n_iter % validation_step == 0:
                    ...
                    solution, recall, room_wise_acc, trip_acc = test_colocation(test_x, test_y, model, fold, args.split)
                    ...
                    #         the_file.write('Epoch: {}. Q error: {}. Trip Accuracy: {}. Best Accuracy: {} %. Best Final Value: {}. Mean Accuracy: {}. Std of Accuracy: {}. Mean Final Value: {}. Std of Final Value: {}. GA Accuracy: {}.'
                    #     .format(n_iter
